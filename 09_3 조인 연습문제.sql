...
FROM employees e
JOIN departments d
ON e. department_id = d.department_id; --106개 조회
--------------------------------------------------
-- LEFT JOIN
SELECT
    *
...
ON e. department_id = d.department_id; --107개 조회
--------------------------------------------------
-- RIGHT JOIN
SELECT
    *
...
ON e. department_id = d.department_id; --122개 조회
------------------------------- RIGHT JOIN
SELECT
    *
FROM employees e
FULL JOIN departments d
ON e. department_id = d.department_id; --123개 조회
--------------------------------------------------------------------------------
/*
문제 2.
...
*/
SELECT
    e.employee_id AS 사원번호, e.first_name,e.salary,
    d.department_id, 
    loc.city
FROM employees e
JOIN departments d
